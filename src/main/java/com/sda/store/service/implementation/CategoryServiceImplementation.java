...
public class CategoryServiceImplementation implements CategoryService {
    ...
    public Category findById(Long id) {
        ...
        if(category.isPresent()) {
            ...
            throw new ResourceNotFoundInDatabase(String.format("The Category ith id %d not found in database",id));
        }
    }
    ...
    public Category findByName(String name) {
        ...
        if(category.isPresent()){
            ...
            throw new ResourceAlreadyPresentInDatabase(String.format("Category with name %s not found.",name));
        }
    }
